...
Aquí tienes el texto corregido con las tildes en LaTeX (`\'`) y la puntuación adecuada en cada ecuación:
...
Como sabemos las soluciones expl\'icitas del problema, podemos ver que es exactamente $u$. Si $q=A \sin (\omega t+\phi)$ entonces $p=m \omega A \cos( \omega t+\phi)$ y la cantidad dentro del logaritmo es: $m \omega A e^{i (\omega t +\phi)}$. De acuerdo a lo anterior:
\[
u=\ln m \omega A+i (\omega t +\phi)-i \omega t=i\phi+\ln \sqrt{2 E m},
\]
