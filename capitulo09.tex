...
Como sabemos las soluciones expl\'icitas del problema, podemos ver que es exactamente $u$,
\eq{
q(t) &= q_0 \cos \omega (t-t_0) + \frac{p_0}{m \omega } \sin \omega (t-t_0), \\
p(t) &= p_0 \cos \omega (t-t_0)- q_0 m \omega  \sin \omega (t-t_0),\\
u &= \ln (p(t)+i m \omega q(t)) - \omega t = -i \omega t_0  +\ln \left(p_0+i m \omega q_0  \right).
}