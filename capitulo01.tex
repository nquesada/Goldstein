...
L'&=\left(\frac{1}{2} m \vec{v} \cdot \vec{v}-q \phi+\frac{q}{c}\vec v \cdot  \vec A\right)+\frac{q}{c}\left(\frac{\partial \psi}{\partial t}+\vec v \cdot \nabla \psi\right).
}
...
\eq{
L&=\frac{1}{2} m r^2 \left(\sin ^2(\theta ) \dot \phi^2+\dot \theta^2\right)+mgr \cos (\theta),\\
